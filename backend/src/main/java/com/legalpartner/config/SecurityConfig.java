    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // without JWT context — permit them so SSE streams don't get Access Denied
                        ...
                        // ONLYOFFICE fetches files and posts callbacks — secured by session token in path
                        .requestMatchers("/api/v1/editor/*/t/*/file").permitAll()
                        .requestMatchers("/api/v1/editor/*/t/*/callback").permitAll()
